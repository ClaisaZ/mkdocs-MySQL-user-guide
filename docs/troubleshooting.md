   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>Schema not refreshed, or the object list has not updated yet.</td>
            <td>Right-click the schema and click Refresh, or reconnect to the server.</td>
         </tr>
         <tr>
            <td>Cannot type in a cell when inserting data.</td>
            <td>You are not editing an empty row yet.</td>
            <td>Click on an empty row (NULL row) at the bottom to start entering data.</td>
         </tr>
         <tr>
